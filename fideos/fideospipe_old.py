...
for fsim in new_list:
    try:
	    ...
	    if DoFull:
		    ...
		    hdufull = GLOBALutils.update_header(hdufull,'RA',ras)
		    hdufull = GLOBALutils.update_header(hdufull,'DEC',decs)
		    ...
		    hdufull = GLOBALutils.update_header(hdufull,'EQUINOX',2000)
